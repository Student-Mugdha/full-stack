...
function HomeNavbar() {
  const navItems = (
    <>
      <li>
        <a
          href="/"
          className="text-[#041c19] font-semibold py-2 px-4 rounded-lg hover:bg-[#2b3d39] transition-all duration-300 ease-in-out"
        >
          Home
        </a>
      </li>
  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 top-0 left-0 right-0">
        <div className="navbar bg-base-100 shadow-lg rounded-lg bg-[#00796b]">
          <div className="navbar-start">
            <div className="dropdown">
              <div
                tabIndex={0}
          ...
          <div className="navbar-end space-x-3">
            ...
            <div>
              <label className="swap swap-rotate">
                ...
                <svg
                  className="swap-on h-7 w-7 fill-current text-blue-800"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                >
            ...
            <div>
              <a
                className="btn w-40 bg-[#041c19] text-white font-semibold py-2 px-4 rounded-lg shadow-lg hover:bg-[#2b3d39] transform transition-all duration-300 ease-in-out"
                onClick={() =>
                  document.getElementById("my_modal_3").showModal()
                }
              >
