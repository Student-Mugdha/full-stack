...
function AboutUs() {
  return (
    <>
      <HomeNavbar />
      <div
        className="bg-[#1D232A] py-10 min-h-screen relative"
        style={{
          backgroundImage:
            'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFe6ZfpKxyE3YOaO0uLsz6NBMi68tP0ocU0g&s")',
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        <div className="bg-black bg-opacity-75 py-10">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h1 className="text-4xl font-bold text-center text-white mb-6">
              About Us
            </h1>
            <p className="text-lg text-gray-300 text-center mb-12">
              Welcome to Fruitbox, your local fresh fruit delivery service. Our
              mission is to bring the freshest fruits directly from local
              vendors to your doorstep. We believe in supporting our local
              farmers and ensuring that our customers enjoy healthy, delicious,
              and sustainably sourced fruits.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              {/* Our Mission */}
              <div className="bg-gray-800 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-300">
                  At Fruitbox, our mission is to connect local fruit vendors
                  with the community and provide an easy and efficient way to
                  access fresh, seasonal fruits. We aim to reduce food waste,
                  support local businesses, and promote healthy living.
                </p>
              </div>
              {/* Why Choose Us */}
              <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                {/* Team Member 1 */}
                <div className="bg-gray-800 p-6 rounded-lg shadow-md text-center h-72 flex flex-col items-center gap-5">
                  <img
                    src="/manas.jpg"
                    alt="Manas Maheshwari"
                    className="w-32 h-32 rounded-full mx-auto mb-4"
                  />
                  <h3 className="text-xl font-semibold text-white">
                    Manas Maheshwari
